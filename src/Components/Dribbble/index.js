            ...
            <div className="  bg-neutral-50">
                <nav className="p-6">
                    <ul className="flex flex-wrap items-center font-bold text-sm ">
                        <li className=" 2xl:inline-block sm:hidden text-xl"> <HiOutlineMenuAlt2 /></li>
                        <li className=" hidden sm:inline-block"> Find designers</li>
                        <li className=" hidden sm:inline-block ml-10">Inspiration</li>
                        <li className=" hidden sm:inline-block ml-10">Courses</li>
                        <li className=" hidden sm:inline-block ml-10">Jobs</li>
                        <li className=" hidden sm:inline-block ml-10">Go Pro</li>
                        <li className=' ml-8 xl:ml-36 font-serif italic font-bold text-3xl '> Dribbble</li>
                        <li className=" ml-48 text-xl font-bold"><CiSearch /></li>
                        <li className='hidden sm:inline-block'><input type="text" className="px-6 py-3 rounded-full text-base font-normal" placeholder='Search... ' /></li>
                        <li className=' ml-6 px-1 py-3 cursor-pointer hidden sm:inline-block '> Log in</li>
                        <li className='ml-4 px-6 py-4 rounded-full bg-slate-900 text-white cursor-pointer hover:bg-zinc-700'>Sign Up</li>
                    </ul>
                </nav>
            </div>
...
<div className="slide_9 ml-10"><img className=" h-96  max-w-2xl  rounded-3xl" src="https://cdn.dribbble.com/uploads/47173/original/Vladimir_Gruev.png?1689174896&format=webp&resize=546x680&vertical=center" alt="" /> <div className=" bottom"><p>Vladimir Gruev<br /> Digital Designer </p> </div><div className="button"><button>Brand</button><button>Design</button></div></div>
            ...
            <div className="grid gap-10 grid-cols-4 grid-rows-3 place-items-start ">
            ...
            <div className="flex flex-wrap pl-9 pr-8">
                <ul>
